...
// The app's real PWA icon (frontend/public/icons/, same backboard/hoop
// "CLUTCH" mark as favicon-v10.png) — reused as-is
...
const LOGO_URL = `${APP_BASE_URL}/icons/icon-v10-192x192.png`;
