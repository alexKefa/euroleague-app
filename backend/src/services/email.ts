...
// The app's real PWA icon (frontend/public/icons/, same "C"-swoosh
// basketball/hoop/"Clutch" mark as favicon-v14.png) — reused as-is
...
const LOGO_URL = `${APP_BASE_URL}/icons/icon-v14-192x192.png`;
